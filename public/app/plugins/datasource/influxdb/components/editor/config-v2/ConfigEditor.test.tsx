...
jest.mock('./UrlAndAuthenticationSection', () => ({
  UrlAndAuthenticationSection: ({ options, onOptionsChange }: any) => <div data-testid="url-auth-section" />,
}));

jest.mock('./DatabaseConnectionSection', () => ({
  DatabaseConnectionSection: ({ options, onOptionsChange }: any) => <div data-testid="db-connection-section" />,
}));
